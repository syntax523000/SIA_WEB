                ...
                <div style="padding:2rem;max-height:70vh;overflow-y:auto;">
                    ...
                    <div style="display:grid;gap:1rem;font-size:1rem;">
                        ...
                        <div>
                            ...
                            <span style="color:#111827;font-weight:500;">
                                🐾 ${escapeHtml(booking.packageName)}${booking.packageId === 'single-service' && booking.singleServices?.length ? ` <span style="color:#6b7280;font-size:0.9rem;">(${booking.singleServices.map(id => getSingleServiceLabel(id)).join(', ')})</span>` : ''}
                            </span>
                        </div>
